...
public class HelpPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) { // Override JPanel paintComponent method
        ...
        try {
            imgTypes = ImageIO.read(new File("Projectile-Motion/images/help/helpTypes.png")); // Load projectile type help
            imgControl = ImageIO.read(new File("Projectile-Motion/images/help/helpControl.png")); // Load control panel help
            imgStat = ImageIO.read(new File("Projectile-Motion/images/help/helpStat.png")); // Load stats panel help
